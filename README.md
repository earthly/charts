...
| `hub.migrateJobBackoffLimit` | How many times the migrate Job may retry before the release fails. This is the retry for transient lock contention; Kubernetes backs off exponentially between attempts (10s, doubling, capped at 6m) | `10` |
