...
| `grafana.topologySpreadConstraints` | Pod topology-spread constraints for Grafana replicas. Empty is NOT "no spread" — the chart applies a soft default (`maxSkew: 1` across `topology.kubernetes.io/zone`, `ScheduleAnyway`); set this to override wholesale | `[]` |
